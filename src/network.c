...
#endif
        printf("Layer       Type           Time             Total time \n"); 
    for(i = 0; i < net.n; ++i){
        net.index = i;
        layer l = net.layers[i];
// get layer time
...
// get layer time
        ...
        if(l.type==CONVOLUTIONAL)
            printf("%03d      Convolution      %9.2f         %12.2f   \n", i, (what_time_is_it_now()-time)*1000,total*1000);
        else if(l.type==MAXPOOL)
            printf("%03d      Maxpool          %9.2f         %12.2f   \n", i, (what_time_is_it_now()-time)*1000,total*1000);
             else 
            printf("%03d      Region           %9.2f         %12.2f   \n", i,( what_time_is_it_now()-time)*1000,total*1000); 
